...
impl Buffer {
    ...
    async fn push(&self, chunks: VecDeque<Bytes>) -> Result<VecDeque<Bytes>, ()> {
    ...
    async fn pull(&self, block_index: u64) -> Result<VecDeque<Bytes>, ()> {
...
impl Flow {
    ...
    pub async fn push(&self, chunks: VecDeque<Bytes>) -> Result<VecDeque<Bytes>, ()> {
        self.buffer.push(chunks).await
    }

    pub async fn pull(&self, block_index: u64) -> Result<VecDeque<Bytes>, ()> {
